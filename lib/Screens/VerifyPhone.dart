...
class VerifyPhone extends StatefulWidget {
  ...
  VerifyPhone({required this.phoneNumber1, required this.verificationId});
...
class _VerifyPhoneState extends State<VerifyPhone> {
  ...
  void initState() {
    ...
    print(widget.phoneNumber1);
    phoneNumber = "+91" + widget.phoneNumber1.toString();
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        Padding(
                          ...
                          child: Text(
                            "Code is sent to " + widget.phoneNumber1,
                            style: TextStyle(
                              fontSize: 22,
